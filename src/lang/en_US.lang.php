...
$sm_lang = array(
	...
	'servers' => array(
		...
		'dns_query' => 'DNS Query',
		'dns_query_description' => 'Query the nameserver for this hostname.',
		'dns_type' => 'Record type',
		'dns_type_description' => 'Search the results for this record type. Usually A (ip-address) or CNAME (host reference).',
		'dns_expected' => 'Expect',
		'dns_expected_description' => 'Expected result from query.',
