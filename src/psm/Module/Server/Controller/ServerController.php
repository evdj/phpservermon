...
class ServerController extends AbstractServerController {
	...
	protected function executeEdit() {
		...
		if(!empty($edit_server)) {
			...
			$tpl_data = array_merge($tpl_data, array(
				...
				'edit_dns_query' => $edit_server['dns_query'],
				'edit_dns_type' => $edit_server['dns_type'],
				'edit_dns_expected' => $edit_server['dns_expected'],
	...
	protected function executeSave() {
		...
		$clean = array(
			...
			'dns_query' => trim(strip_tags(psm_POST('dns_query', ''))),
			'dns_type' => strtoupper(trim(strip_tags(psm_POST('dns_type', '')))),
			'dns_expected' => trim(strip_tags(psm_POST('dns_expected', ''))),
	...
	protected function getLabels() {
		return array(
			...
			'label_dns_query' => psm_get_lang('servers', 'dns_query'),
			'label_dns_query_description' => psm_get_lang('servers', 'dns_query_description'),
			'label_dns_type' => psm_get_lang('servers', 'dns_type'),
			'label_dns_type_description' => psm_get_lang('servers', 'dns_type_description'),
			'label_dns_expected' => psm_get_lang('servers', 'dns_expected'),
			'label_dns_expected_description' => psm_get_lang('servers', 'dns_expected_description'),
			...
			'label_dns' => psm_get_lang('servers', 'type_dns'),
